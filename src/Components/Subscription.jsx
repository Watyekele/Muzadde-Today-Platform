  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      <div className="w-full max-w-md p-6 bg-gray-100 rounded-lg shadow-md">
        <h2 className="text-2xl text-green-900 font-bold mb-4">Subscribe To Muzadde Plus</h2>
        <p className="text-gray-600 mb-4">Subscribe today to gain premium access!</p>
