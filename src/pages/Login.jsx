...
<<<<<<< HEAD:src/Components/Login.jsx
            ...
            >
=======
            <button className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-gray-700 rounded-md hover:bg-pink-600 focus:outline-none focus:bg-purple-600">
>>>>>>> develop:src/pages/Login.jsx
              Login
            </button>
          </div>
...
=======
            ...
            onClick={() => console.log("Continue with Google clicked")} // Replace with your Google authentication logic
>>>>>>> develop:src/pages/Login.jsx
          >
            <svg
...
=======
              className="w-5 h-5 fill-current text-blue-600" // Replace with the desired color
>>>>>>> develop:src/pages/Login.jsx
            >
