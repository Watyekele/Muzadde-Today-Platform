    ...
    <div>
      ...
      <div className="page bg-pink-50 text-lg mt-20 pl-16">
        ...
        <section className="text-left ml-6 my-10">
          ...
          <div className="flex justify-right p-2 m-2">
            <textarea
              ...
              className="border p-2 w-full max-w-md" // Adjusted max-width
              required
            ></textarea>
            <button
        ...
        <section className="content-center flex flex-wrap font-bold space-x-2 mb-4">
          <button className="bg-gray-200 px-6 py-2 rounded-full">All</button>
          <button className="bg-gray-200 px-6 py-2 rounded-md">Nutrition</button>
          <button className="bg-gray-200 px-6 py-2 rounded-md">
            Child Psychologist
          </button>
          <button className="bg-gray-200 px-6 py-2 rounded-md">Gynecologist</button>
          <button className="bg-gray-200 px-6 py-2 rounded-md">Pediatrician</button>
          <button className="bg-gray-200 px-6 py-2 rounded-md">
          ...
          {questions.map((q, index) => (
            <div key={index} className="question-one mb-6">
              <section>
                ...
                <p className="text-xl p-2 transition transform hover:-translate-x-1 hover:scale-90 duration-50">
                  {q.question}
                </p>
              </section>
              <section>
        ...
        <div className="experts-section">
          ...
          <div className="experts flex flex-wrap mt-4">
            <section className="mr-3 text-center">
              ...
              />
              <p className="font-bold">Dr. Paul Wasswa</p>
              <p>Gynecologist</p>
            </section>
            <section className="mr-3 text-center">
              <img
                ...
                className="rounded-md w-48 h-64 object-cover"
              />
              <p className="font-bold">Dr. Miranda Atim</p>
            ...
            <section className="mr-3 text-center">
              <img
                ...
                className="rounded-md w-48 h-64 object-cover"
              />
              <p className="font-bold">Dr. Robinah Kitiibwa</p>
              <p>Nutritionist</p>
            </section>
            ...
            <section className="mr-3 text-center">
              <img
                ...
                className="rounded-md w-48 h-64 object-cover"
              />
              <p className="font-bold">Dr. Muwanga John</p>
              <p>Gynecologist</p>
            </section>
            <section className="mr-3 text-center">
              <img
                ...
                className="rounded-md w-48 h-64 object-cover"
              />
              <p className="font-bold">Dr. Lubanga Christine</p>
              <p>Paediatrician</p>
            </section>
          </div>
        </div>
